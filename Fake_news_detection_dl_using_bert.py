# -*- coding: utf-8 -*-
"""
Fake News Detection USING BERT on liar dataset
...
training = model.fit(df_train['text'], df_train['bin_label'], epochs=5, batch_size = 64)

dic_y_mapping = dict(df_train[['label', 'bin_label']].drop_duplicates().values)
predicted_prob = model.predict(df_test.astype(str)['bin_label'])
